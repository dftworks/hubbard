...
special cases where the rotation preserves the local interaction.
Chapter~\ref{chap:orbitalrotations} implements the required four-index
operator for faithful wavelet, natural-orbital, or learned-orbital
calculations at finite $U$.
