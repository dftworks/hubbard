...
\mainmatter
\input{chapters/01_model_and_basis}
\input{chapters/02_fermionic_operators}
\input{chapters/03_sparse_hamiltonian}
\input{chapters/04_matrix_free_lanczos}
\input{chapters/05_observables}
\input{chapters/06_validation}
\input{chapters/07_general_hopping}
\input{chapters/08_exact_orbital_rotations}
\input{chapters/09_research_extensions}
...
\code{interactions.py} & General up--down interaction tensors \\
\code{orbitals.py} & Exact one- and two-body basis transformations \\
