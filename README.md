...
incrementally and includes seven runnable programs directly in the manuscript.
...
and complex generic hopping matrices.  It also derives the four-index
interaction generated by an orbital rotation and explains why rotating only
the one-body matrix is insufficient at finite `U`.
